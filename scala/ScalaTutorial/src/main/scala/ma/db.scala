...
object db {
  def main(args: Array[String]): Unit = {
    ...
    var evenList = for {i <- 1 to 20
       // You can put as many conditions here separated with semicolons as you need
       if (i % 2) == 0
    } yield i
...
//    } while(numberGuess != 15)
    ...
    friends(0) = "Sue"
    println("Best Friend: " + friends.mkString(", "))
    ...
    println("Friends2: " + friends2.mkString(", "))
