class GroovyTut {
    static void main(String[] args) {
        ...
        // Decimal accuracy
        println("1.1000000000000000001 + 1.1000000000000000001 =" + (1.1000000000000000001+1.1000000000000000001))
        ...
        // Use multiple values
        // -10s, padding on the right, 10s padding on the left
        printf("%-10s %d %.2f %10s \n", ['Stuff', 10, 1.234, 'Random']);


        /* INPUT
            // This will not work in Intellij
        ...
        */
        ...
        // Get last item
        println("Get Last: " + aToZ.getTo());

        println("Get First: " + aToZ.getFrom());
